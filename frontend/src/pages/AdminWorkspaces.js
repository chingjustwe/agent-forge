...
import { fetchAdminWorkspaces, createAdminWorkspace, updateAdminWorkspace, archiveWorkspace, purgeWorkspace, setDefaultWorkspace, addWorkspaceMember, removeWorkspaceMember, fetchWorkspaceMembers, fetchUsers } from "../api";
export default function AdminWorkspaces() {
    ...
    const [purgeWs, setPurgeWs] = useState(null);
    ...
    return (_jsxs("div", { children: [_jsxs("div", { className: "page-header", children: [_jsx("h1", { className: "page-title", children: "Workspace Management" }), _jsx("p", { className: "page-subtitle", children: "Manage workspaces, quotas, and settings" })] }), message && _jsx("div", { className: `alert alert-${messageType}`, children: message }), _jsxs("div", { className: "card", style: { marginBottom: 20 }, children: [_jsx("div", { className: "card-header", children: _jsx("h3", { className: "card-title", children: "Create Workspace" }) }), creating ? (_jsxs("form", { onSubmit: handleCreate, style: { display: "flex", flexDirection: "column", gap: 8 }, children: [_jsxs("div", { style: { display: "flex", gap: 8 }, children: [_jsx("input", { value: newWsName, onChange: (e) => setNewWsName(e.target.value), placeholder: "Workspace name *", style: { flex: 1 }, autoFocus: true }), _jsx("input", { value: newWsIcon, onChange: (e) => setNewWsIcon(e.target.value), placeholder: "Icon (emoji or URL)", style: { width: 180 } })] }), _jsxs("div", { style: { display: "flex", gap: 8 }, children: [_jsx("input", { value: newWsSlug, onChange: (e) => setNewWsSlug(e.target.value), placeholder: "Slug (optional, auto-generated from name)", style: { flex: 1 } }), _jsx("input", { value: newWsDescription, onChange: (e) => setNewWsDescription(e.target.value), placeholder: "Description (optional)", style: { flex: 1 } })] }), _jsxs("div", { style: { display: "flex", gap: 8 }, children: [_jsx("button", { type: "submit", className: "btn btn-primary", children: "Create" }), _jsx("button", { type: "button", className: "btn btn-secondary", onClick: () => { setCreating(false); setNewWsName(""); setNewWsSlug(""); setNewWsDescription(""); setNewWsIcon(""); }, children: "Cancel" })] })] })) : (_jsx("button", { className: "btn btn-primary", onClick: () => setCreating(true), children: "+ New Workspace" }))] }), loading ? (_jsx("div", { className: "loading", children: "Loading workspaces" })) : (_jsxs(_Fragment, { children: [_jsx("div", { className: "table-container", children: _jsxs("table", { children: [_jsx("thead", { children: _jsxs("tr", { children: [_jsx("th", { style: { width: 40 }, children: "Icon" }), _jsx("th", { children: "Name" }), _jsx("th", { children: "Slug" }), _jsx("th", { children: "Description" }), _jsx("th", { children: "Members" }), _jsx("th", { children: "Agents" }), _jsx("th", { children: "Created" }), _jsx("th", { children: "Actions" })] }) }), _jsx("tbody", { children: workspaces.map((ws) => (_jsxs("tr", { children: [_jsx("td", { style: { width: 32, maxWidth: 32, overflow: "hidden", textAlign: "center" }, children: ws.icon ? (/^https?:\/\//.test(ws.icon) ? (_jsx("img", { src: ws.icon, alt: "", style: { width: 20, height: 20, objectFit: "contain", verticalAlign: "middle" } })) : (_jsx("span", { style: { fontSize: "1.1rem" }, children: ws.icon }))) : null }), _jsx("td", { children: editingId === ws.id ? (_jsx("input", { value: editName, onChange: (e) => setEditName(e.target.value) })) : (_jsxs("span", { style: { display: "inline-flex", alignItems: "center", gap: 6, flexWrap: "wrap" }, children: [ws.name, ws.is_default && (_jsx("span", { className: "badge badge-success", style: { fontSize: "0.7rem" }, children: "Default" })), ws.archived && (_jsx("span", { className: "badge badge-error", style: { fontSize: "0.7rem" }, children: "Archived" }))] })) }), _jsx("td", { style: { fontSize: "0.82rem", color: "var(--text-secondary)" }, children: editingId === ws.id ? (_jsx("input", { value: editSlug, onChange: (e) => setEditSlug(e.target.value), placeholder: "slug", style: { width: 120 } })) : (ws.slug || "") }), _jsx("td", { style: { fontSize: "0.82rem", color: "var(--text-secondary)" }, children: editingId === ws.id ? (_jsx("input", { value: editDescription, onChange: (e) => setEditDescription(e.target.value), placeholder: "description", style: { width: 160 } })) : (ws.description || "") }), _jsx("td", { children: ws.member_count }), _jsx("td", { children: ws.agent_count }), _jsx("td", { style: { fontSize: "0.82rem", color: "var(--text-secondary)" }, children: new Date(ws.created_at).toLocaleDateString() }), _jsx("td", { children: editingId === ws.id ? (_jsxs("div", { style: { display: "flex", flexDirection: "column", gap: 6 }, children: [_jsxs("div", { children: [_jsx("label", { style: { fontSize: "0.75rem", color: "var(--text-muted)", marginRight: 4 }, children: "Icon:" }), _jsx("input", { value: editIcon, onChange: (e) => setEditIcon(e.target.value), placeholder: "emoji / URL", style: { width: 120 } })] }), _jsxs("div", { children: [_jsx("label", { style: { fontSize: "0.75rem", color: "var(--text-muted)", marginRight: 4 }, children: "Tokens/day:" }), _jsx("input", { type: "number", value: editTokens, onChange: (e) => setEditTokens(Number(e.target.value)), style: { width: 80 } })] }), _jsxs("div", { children: [_jsx("label", { style: { fontSize: "0.75rem", color: "var(--text-muted)", marginRight: 4 }, children: "Cost/month:" }), _jsx("input", { type: "number", value: editCost, onChange: (e) => setEditCost(Number(e.target.value)), style: { width: 80 } })] }), _jsxs("div", { className: "btn-group", children: [_jsx("button", { className: "btn btn-primary btn-sm", onClick: () => handleSave(ws.id), children: "Save" }), _jsx("button", { className: "btn btn-secondary btn-sm", onClick: () => setEditingId(null), children: "Cancel" })] })] })) : (_jsx("div", { className: "btn-group", children: ws.archived ? (
                                                    ...
                                                    _jsx("button", { className: "btn btn-danger btn-sm", onClick: () => openPurge(ws), title: "Permanently delete this workspace and all its data", children: "Purge" })) : (_jsxs(_Fragment, { children: [_jsx("button", { className: "btn btn-secondary btn-sm", onClick: () => { setEditingId(ws.id); setEditName(ws.name); setEditSlug(ws.slug || ""); setEditDescription(ws.description || ""); setEditIcon(ws.icon || ""); setEditTokens(0); setEditCost(0); }, children: "Edit" }), _jsx("button", { className: "btn btn-secondary btn-sm", onClick: () => openMembers(ws.id), children: "Members" }), !ws.is_default && (_jsx("button", { className: "btn btn-secondary btn-sm", onClick: () => handleSetDefault(ws.id), disabled: settingDefault === ws.id, title: "Set as the default workspace for new users", children: settingDefault === ws.id ? "Setting..." : "Set as default" })), !ws.is_default && (_jsx("button", { className: "btn btn-danger btn-sm", onClick: () => handleArchive(ws.id, ws.name), children: "Archive" }))] })) })) })] }, ws.id))) })] }) }), memberWsId && (_jsxs("div", { className: "card", style: { marginTop: 20 }, children: [_jsx("div", { className: "card-header", children: _jsxs("h3", { className: "card-title", children: ["Members of ", workspaces.find(w => w.id === memberWsId)?.name || memberWsId] }) }), memberLoading ? (_jsx("div", { className: "loading", style: { padding: 12 }, children: "Loading members..." })) : (_jsxs(_Fragment, { children: [members.length === 0 ? (_jsx("p", { style: { padding: 12, color: "var(--text-muted)" }, children: "No members yet." })) : (_jsxs("table", { children: [_jsx("thead", { children: _jsxs("tr", { children: [_jsx("th", { children: "Email" }), _jsx("th", { children: "Name" }), _jsx("th", { children: "Role" }), _jsx("th", { children: "Actions" })] }) }), _jsx("tbody", { children: members.map((m) => (_jsxs("tr", { children: [_jsx("td", { children: m.email }), _jsx("td", { children: m.name }), _jsx("td", { children: _jsx("span", { className: "badge badge-primary", children: m.role }) }), _jsx("td", { children: _jsx("button", { className: "btn btn-danger btn-sm", onClick: () => handleRemoveMember(m.user_id, m.email), children: "Remove" }) })] }, m.user_id))) })] })), _jsx("div", { style: { padding: 12, borderTop: "1px solid var(--border)" }, children: _jsxs("div", { style: { display: "flex", gap: 8, alignItems: "flex-end" }, children: [_jsxs("div", { className: "form-group", style: { flex: 1, margin: 0, position: "relative" }, children: [_jsx("label", { className: "form-label", children: "Search registered users" }), _jsx("input", { value: searchQuery, onChange: e => handleSearch(e.target.value), placeholder: "Search by name or email...", onFocus: () => searchResults.length > 0 && setShowDropdown(true), onBlur: () => setTimeout(() => setShowDropdown(false), 200) }), showDropdown && (_jsx("div", { style: {
                                                                ...
                                                                }, onMouseDown: () => handleAddMember(u.id, u.name || u.email), children: [_jsxs("div", { style: { flex: 1 }, children: [_jsx("div", { style: { fontSize: "0.9rem" }, children: u.name || u.email }), _jsx("div", { style: { fontSize: "0.75rem", color: "var(--text-muted)" }, children: u.email })] }), _jsx("span", { className: "badge badge-primary", style: { fontSize: "0.7rem" }, children: u.role }), _jsx("button", { className: "btn btn-primary btn-sm", disabled: addingUser === u.id, children: addingUser === u.id ? "Adding..." : "Add" })] }, u.id)))) }))] }), _jsxs("div", { className: "form-group", style: { margin: 0 }, children: [_jsx("label", { className: "form-label", children: "Role" }), _jsxs("select", { value: addRole, onChange: e => setAddRole(e.target.value), children: [_jsx("option", { value: "member", children: "Member" }), _jsx("option", { value: "workspace_admin", children: "Admin" }), _jsx("option", { value: "viewer", children: "Viewer" })] })] }), _jsx("button", { className: "btn btn-secondary", onClick: () => setMemberWsId(null), style: { marginBottom: 0 }, children: "Close" })] }) })] }))] }))] })), purgeWs && (_jsx("div", { className: "modal-backdrop", onClick: () => !purging && setPurgeWs(null), children: _jsxs("div", { className: "card modal-card", onClick: e => e.stopPropagation(), style: { maxWidth: 480 }, children: [_jsx("div", { className: "card-header", children: _jsx("h3", { className: "card-title", children: "Purge workspace" }) }), _jsxs("div", { className: "alert alert-error", style: { marginTop: 8 }, children: ["This will permanently delete ", _jsx("strong", { children: purgeWs.name }), " and ALL its data (sessions, agents, API keys, invitations, logs). This cannot be undone."] }), _jsxs("div", { className: "form-group", style: { marginTop: 12 }, children: [_jsx("label", { className: "form-label", children: "Type the workspace name to confirm:" }), _jsx("input", { type: "text", value: purgeInput, onChange: e => setPurgeInput(e.target.value), placeholder: purgeWs.name, autoFocus: true, style: { fontFamily: "monospace" } })] }), _jsxs("div", { style: { display: "flex", gap: 8, marginTop: 8 }, children: [_jsx("button", { className: "btn btn-danger", onClick: handlePurge, disabled: purging || purgeInput !== purgeWs.name, children: purging ? "Purging..." : "Purge permanently" }), _jsx("button", { className: "btn btn-secondary", onClick: () => setPurgeWs(null), disabled: purging, children: "Cancel" })] })] }) }))] }));
}
